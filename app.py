...
def job_analyzer():
    ...
    if request.method == "POST":
        ...
        if resume_file and job_description:
            ...
            prompt = (
                "You are an expert career advisor. Your task is to compare the following resume and job description.\n\n"
                "Resume:\n\n{resume}\n\n"
                "Job Description:\n\n{jd}\n\n"
                "Provide a detailed, structured analysis with the following five sections.\n"
                "Strictly follow these formatting and content rules:\n\n"
                "1️⃣ - Present Skills:\n"
                "List all technical skills explicitly found in the resume.\n"
                "Present them as a clean numbered list.\n"
                "Each skill must appear on a new line, prefixed with a number (e.g.,\n"
                "1. Python\n"
                "2. Java\n"
                "3. SQL)\n"
                "Do NOT group multiple skills on a single line.\n\n"
                "2️⃣ - Present Keywords:\n"
                "List other non-technical keywords or phrases present in the resume that are relevant (e.g., teamwork, leadership).\n"
                "Follow the same clean numbered list format.\n"
                "Each keyword must be on a new line, prefixed with a number.\n\n"
                "3️⃣ - Missing Skills:\n"
                "List technical skills mentioned in the job description but NOT found in the resume.\n"
                "Use the same numbered list format with one skill per line.\n\n"
                "4️⃣ - Missing Keywords:\n"
                "List non-technical keywords or phrases from the job description that are NOT present in the resume.\n"
                "Use the same clean numbered list format.\n\n"
                "5️⃣ - Improvement Suggestions:\n"
                "Provide exactly **3 actionable suggestions** to improve the resume and better match the job description.\n"
